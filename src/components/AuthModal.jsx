...
import { ShieldCheck, Mail, User, ArrowRight, ShieldAlert, Loader2, CheckCircle2, Copy, KeyRound, LogIn, UserPlus, Eye, EyeOff } from 'lucide-react';
...
export default function AuthModal({ onLogin }) {
  ...
  // Registration success state — shows the generated password
  ...
  // ── Continue after registration (auto-login) ──
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/90 backdrop-blur-xl animate-fade-in select-none">
      <div className="w-full max-w-md glass-modal rounded-3xl p-8 border border-emerald-500/20 shadow-2xl relative overflow-hidden">
        ...
        {/* Tab Switcher — only show when NOT in registration-complete state */}
        ...
        {/* ── REGISTRATION COMPLETE — Show Generated Password ── */}
        {registrationComplete && (
          <div className="space-y-4 relative animate-fade-in">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-400">
                Your permanent password has been generated. <strong className="text-amber-400">Save it now — it won't be shown again!</strong>
              </p>
            </div>
            ...
            <div className="p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl text-xs text-amber-300 space-y-1">
              ...
              <ul className="list-disc list-inside text-amber-400/80 space-y-0.5">
                ...
                <li>Use it with your email to sign in next time</li>
              </ul>
            </div>
            ...
            >
              <span>I've Saved My Password — Continue</span>
        ...
        {/* ── LOGIN FORM ── */}
        {activeTab === 'login' && !registrationComplete && (
        ...
        {/* ── REGISTER FORM ── */}
        {activeTab === 'register' && !registrationComplete && (
